...
import com.aventstack.extentreports.reporter.configuration.Theme;
	...
	public class ExtentReportManager implements ITestListener {
		...
		public void onFinish(ITestContext testContext) {
			...
			extent.flush();   // it makes everything is ready in the report
			...
			sendEmail("kekaneshantanu@gmail.com","hmvt kabe qtck enxp","dnyaneshwarikekane@gmail.com");
		}
		...
		public void sendEmail(String senderEmail,String senderPassword,String recipientEmail)
		{
	        ...
	        //properties.put("mail.smtp.ssl.ciphersuites", "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256");
